...
<!-- #include virtual = "/include/function_erp.asp" -->
	...
	<!-- 개별 css, js -->
    <script src="/pc/resource/js/pages/member_220822.js?v=202210061906"></script>

    <link rel="stylesheet" href="/pc/resource/css/sub_220822.css">
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <!-- #include virtual = "/pc/layout/location.asp" -->	
    
            <!-- start of :: contents -->
            <div id="contents">
                <div class="member_wrap join2 _220824">
                    <h3>Member Join</h3>
                    <div class="join-member__top">
                        <p>카카오 간편 회원가입으로<br/>
                        보다 간편하게 회원가입이 가능합니다.</p>
                        <a href="javascript:snsJoin('KK');void(0);" class="join-kakao">카카오 간편 회원가입</a>
                    </div>
                    <div class="oh">
                        <!--필수정보입력-->
                        <div class="inp_form fl">
                            <form name="idform">
                            ...
                            <form name="myform" class="join_form join_form_style ">
                                ...
                                <input type="hidden" name="joinGbn" id="joinGbn" value="<%=joinGbn%>" >
                                ...
                                <fieldset>
                                    <legend class="hidden">필수정보입력 폼</legend>
                                    <h3 class="tit__style2 small">필수정보 입력<span>*필수입력</span></h3>
                                    <div class="member_join _220824">
                                        <div>
                                            <div class="input_area inp_area fl">
                                                <div class="red id">
                                                    <label for="">아이디
                                                        <!-- 활성화시 추가되는 class명 .hd_txt -->
                                                        <span class="" id="idCheckText">아이디를 입력해주세요.</span>
                                                    </label>		
                                                    <input type="text" class="inp_style" name="memberId" id="joinId" maxlength="16" onChange="document.myform.id_check.value='';" style="text-transform: lowercase;" >
                                                    <a href="javascript:checkidN();">중복확인</a>	
                                                                                
                                                </div>
                                                <div class="red">
                                                    <label for="">비밀번호<span class="" id="pwResult3">비밀번호를 입력해주세요.</span>	</label>												
                                                    <input id="" type="password" class="inp_style" name="memberPassword" id="memberPassword" placeholder="8-16자:영문,숫자,특수문자 조합" maxlength="16">
                                                    &nbsp;<em id="pwResult" style="color:#cc3333; font-style:normal; font-family:dotum; font-size:12px;"></em>&nbsp;<span id="pwResult" class="id_txt" ></span>
                                                </div>
                                                <div class="red mt7">
                                                    <label for="">비밀번호 확인<span class="" id="pwResult2">비밀번호가  일치하지 않습니다.</span></label>												
                                                    <input type="password" class="inp_style" name="memberPassword2" id="memberPassword2" placeholder="비밀번호를 한번 더 입력해 주세요." maxlength="16">
                                                </div>
                                                
                                                
                                            </div>
                                            <div class="input_area inp_area fr">
                                                <div class= "join_name disabled " >
                                                    <div class="inp_name red" id="memberNameTxt">
                                                        <label for="">이름<span class="" id="nameCheckText">이름을 입력해주세요.</span></label>
                                                        <input type="text" class="inp_style " name="memberName" id="memberName" maxlength="">
                                                    </div>
                                                    ...
                                                    <div class="birth red">
                                                        <label for="">생년월일<span class="" id="bdayCheckText">생년월일을 선택해주세요.</span></label>
                                                        <div class="bday2" id="bday2" style="display:none;"></div>
                    ...
                    %>
                        ...
                        %>
                                                    ...
                                                    <div class="red phn">
                                                        <label for="">휴대폰 번호<span class="" id="phoneCheckText">휴대폰 번호를 입력해주세요.</span></label>
                                                        <div id="hplist2" style="display:none;"></div>
                                                        <div id="hplist" class="select__style mt10	">
                                                            <select name="cellphone" id="cellphone" class="phone-sel" onchange="categoryOp();">
                                                                ...
                                                                <input type="text" id="phone1" name="phone1" class="inp_style" title="휴대폰 통신사 번호 입력창" style="width:65px;" maxlength="3" validate="required;" validatetext="휴대전화번호">
                                                                <span class="hyphen">ㅡ</span>
                                                                <input type="text" id="phone2" name="phone2" class="inp_style" title="휴대폰 중간 번호 입력창" style="width:70px;" maxlength="4" validate="required;" validatetext="휴대전화번호">
                                                                <span class="hyphen">ㅡ</span>
                                                                <input type="text" id="phone3" name="phone3" class="inp_style" title="휴대폰 마지막 번호 입력창" style="width:70px;" maxlength="4" validate="required;" validatetext="휴대전화번호">
                                                    ...
                                                    <div class="red phn self-verif-box">
                                                        <label for="">본인 인증<span class="" id="certCheckText">본인인증을 진행해주세요.</span></label>
    
                                                        <div class="selfv_all hbox">
                                                            <div class="inp chk">
                                                            ...
                                                            <button type="button" class="selfv_btn btn_style1" onclick="confirmJoin();" id="loginbtn">본인인증</button>	
                                                            <button type="button" class="arr-down" id="loginbtn2" style="display:none;"><img src="/pc/resource/images/membership/arr_down_bl_11x7.png" alt=""></button>
                                                        </div>
    
                                                        <ul class="selfv_list cbox">
                                                            <li>
                                                                ...
                                                                <button type="button" class="btn_view"><img src="/pc/resource/images/common/arr_right_bk_6x10.png" alt=""></button>
                                                                <div class="cs-agree-con" style="margin: 0;">
                                                                    <div class="head">
                                                                        <h2>개인정보이용동의</h2>
    ...
    상기와 같이 고유식별정보 이용 및 처리에 동의합니다.<br>
                                                            ...
                                                            <li>
                                                                ...
                                                                <label for="Certagree3">서비스이용약관동의</label>
                                                                <button type="button" class="btn_view"><img src="/pc/resource/images/common/arr_right_bk_6x10.png" alt=""></button>
                                                                <div class="cs-agree-con" style="margin: 0;">
                                                                    <div class="head">
                                                                        <h2>서비스이용약관동의</h2>
    ...
    <p></p>
                                                            ...
                                                            <!--<li>
                                                                ...
                                                                <label for="s_agree5">통신사이용약관 동의</label>
                                                                <button type="button" class="btn_view"><img src="/pc/resource/images/common/arr_right_bk_6x10.png" alt=""></button>
                                                            </li>-->
                                                        </ul>
    
                                                        <div class="certif-box" id="certAfter" style="display:none;" >
                                                            <div class="num">
                                                            ...
                                                            <div class="btn-confirm">
                                                                <a href="javascript:confirmReturn();void(0);" class="btn_style1 btn-submit">확인</a>
                                                                <a href="javascript:confirmJoin();void(0);" class="btn_style1 btn-resubmit">재전송</a>
                                                            </div>
                        ...
                        <!--부가정보입력-->
                        <div class="inp_form-sub">
                                <fieldset>
                                    <legend class="hidden">부가정보입력 폼</legend>
                                    <h3 class="tit__style2">부가정보 입력<span>(선택)</span></h3>
                                    <div class="member_join">
                                        <div>
                                            <div class="input_area">
                                                ...
                                                <!-- <div class="birth">
                                                    <span>
                                                        <input type="checkbox" class=" chk__style  _basic_type" name="birthdaySex" id="birthdaySex" value="1">
                                                        <label for="birthdaySex" class="join_label ">생년월일 / 성별 정보 제공 동의</label>
                                                    </span>
                                                </div> -->
                                                ...
                                                <div class="email">
                                                    <label for="">이메일</label>												
                                                    <input name="email1" id="userEmail" type="text" class="inp_style" value="" >
                                                    <span>@</span>
                                                    <input name="email2" id="userEmail2" type="text" class="inp_style" maxlength="50" value="" >
                                                    <span class="select__style"	>
                                                ...
                                                <div class="txt re">
                                                    휴대폰 / 이메일에 수신동의 하시면 메일을 통해 신상품 및 여러가지 정보를 우선적으로 받아보실 수 있습니다. <br>
                                                    회원가입 / 주문배송 관련 등의 메일은 수신동의와 상관없이 모든 회원에게 발송됩니다.
                                                </div>
                    ...
                    <!-- 2021-03-02 개인정보 수정-->
                    <div class="join_terms new210302">
                        <div class="tit__box" style="display: flex; align-items: center;">
                            <p class="tit">KEDS 이용약관 및 마케팅 정보 수신 동의</p><span class="" id="termsCheckText">필수 약관에 체크해주세요.</span>
                        </div>
                        <ul class="toggle_all">
                            <li class="all w100">
                                <span>
                                    <input type="checkbox" class=" chk__style  _basic_type" name="all1" id="all1" onclick="agreeAll2022();">
                                    <label for="all1" class="join_label ">KEDS 이용약관 및 마케팅 정보 수신에 모두 동의 합니다.</label>
                                </span>
                                <a href="">
                                    <span class="fr"></span>
                                </a>			
                            </li>
                            <li class="mt18 mt18_01">
                                <p>
                                    <input type="checkbox" class=" chk__style  _basic_type" name="agree1" id="agree1" onclick="agrees2022();">
                                    <label for="agree1" class="join_label ">이용약관 <span class="red">(필수)</span></label>
                                </p>
                                <button type="button" class="btn_view"><img src="/pc/resource/images/common/arr_right_bk_6x10.png" alt=""></button>
                                <div class="cs-agree-con">
                                    <div class="head">
                                        <h2 class="cs-agree-con_title">통합회원 이용약관</h2>
                                        <button type="button" class="btn_close"><img src="/pc/resource/images/common/ico_x_bk_18x18.png" alt=""></button>
                                    </div>
                                    <div class="box _scroll">
                                        <p>
                                            ...
                                            OUTLET, Zooyork, Keds 브랜드 관련하여 제공하는 서비스 (회사 사이트에서 제공하는 인터넷 관련 서비스를 포함함)를 이용함에 있어서 회사와 회원의 권리, 의무 및 책임사항을 규정하고, 회원의 서비스 이용조건 및 절차에 관한 사항과 기타 필요한 사항을 규정함을 목적으로 합니다.<br><br>
    
    
                                            <strong>제 2조 용어의 정의</strong><br><br>
                                            (1) ‘회원’이란 이 약관을 승인하고 회사에 개인정보를 제공하여 회원가입을 신청한 자로서, 매장 및 모바일 어플 등을 통해 가입한 회원과 사이트를 통하여 가입한 회원을 총칭하며, 이 약관에서 정한 절차 또는 관련 법령에 따라 이 약관이 해지되지 않는 한, 회사가 제공하는 정보를 지속적으로 제공받으며, 회사가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.<br>
    
                                            (2) ‘서비스'란 회사가 회원에게 제공하는 서비스 정책으로서 회원의 구매이력 등을 관리하고 매장 및 공식 사이트에서 구매에 따른 각종 정보와 구매편의, 다양한 혜택을 제공하기 위하여 만든 서비스 정책(이하 “서비스")을 말합니다. <br>
    
                                            (3) '회원번호'란 회원의 식별 및 서비스 이용을 위하여 가입 시, 최초 회사가 회원 별로 부여하는 고유한 숫자의 조합을 말합니다.<br>
    
                                            (4) '아이디(ID)'란 회원의 식별과 사이트 내 서비스 이용을 위하여 사이트에서 회원가입 시, 회원이 등록한 고유의 문자와 숫자의 조합을 말합니다.<br>
    
                                            (5) ‘비밀번호’란 회원이 본인 여부를 검증하기 위하여, 회원이 등록한 고유의 문자와 숫자의 조합을 말합니다. <br>
    
                                            (6) ‘매장’이란 회사에서 운영하는 직영점 또는 별도의 가입규약이나 계약을 체결하여 이 약관에 따른 제반 서비스를 공동으로 제공 및 운영하기로 한 매장을 말합니다. 매장 여부는 사이트 내 ‘매장안내' 화면 또는 FILA고객센터(1577-3472)를 통해 확인할 수 있습니다.<br>
    
                                            (7) ‘사이트’란 회사가 상품 등 재화 또는 용역을 회원에게 제공하기 위하여 컴퓨터 등 정보통신 설비를 이용하여 상품 등 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말합니다.<br>
    
                                            (8) ‘포인트’란 회사가 제공하는 서비스를 이용할 때 회사의 재량에 따라 회원에게 부여되는 환가 불가능한 회사 전용의 비재산적 데이터를 말합니다. <br>
    
                                            (9) ‘쿠폰'이란 회원이 상품을 구매할 때나 회사가 제공하는 서비스를 이용할 때 회사의 재량에 따라 회원에게 발행∙지급되는 할인 수단을 말합니다. 쿠폰은 정률 쿠폰(ex. 15% 할인)과 정액 쿠폰(ex. 5000원 할인)으로 구분됩니다. <br><br>
    
                                            <strong>제 3조 서비스 개요</strong><br><br>
                                            (1) 회원이 회사의 서비스를 제공 받기 위해서는 이 약관에서 정하고 있는 제반 절차를 거쳐 회원으로 가입해야 합니다.<br>
    
                                            (2) 회사는 회원에게 보다 나은 서비스의 제공을 위하여 회원등급을 분류하여 등급에 따라 서비스 및 혜택을 달리하여 제공합니다. <br>
                                            회원등급 및 그에 따른 혜택에 대하여는 이용실적, 기타 회사가 정하는 이용정책에 정한 기준에 따라 부여됩니다. <br>
                                            상세한 내역은 해당 서비스 화면[고객센터]-[멤버십]에 공지합니다. <br>
                                            <a href="/customer/notice_view.asp?seq=3&page=1" style="text-decoration:underline;">[멤버십] 바로가기</a><br>
    
                                            (3) 서비스는 회원 본인이 직접 회사에서 규정한 탈퇴 양식을 갖춰 멤버십 탈퇴의사를 전달한 경우 또는 관련법령에 따라 1년간 서비스 이용실적이 없는 경우를 제외하고는 유효하게 제공됩니다.<br><br>
    
    
    
                                            <strong>제 4조 회원 가입 절차</strong><br><br>
                                            (1) 매장 및 모바일 어플을 통해 회원 가입을 신청하는 경우, 회사에서 요청하는 개인정보를 작성한 후 약관 동의 및 실명인증을 진행하고 나면 회원 가입이 됩니다. 본 절차를 통해 가입한 회원은 서비스 혜택을 즉시 부여 받을 수 있습니다.<br>
    
                                            (2) 사이트를 통해 회원가입 신청을 하는 경우, 사이트 내 회원가입 절차만을 거치면 사이트 및 멤버십 서비스를 모두 이용할 수 있습니다. <br>
                                            단, 전항에 따라 가입한 회원이 사이트 서비스도 이용할 수 있는 회원이 되려면 사이트 내 추가 회원가입 절차를 진행하여 미비된 입력 사항을 추가 기재한 후 사이트 서비스를 이용할 수 있습니다.<br>
    
                                            (3) 회원의 권리 및 의무는 본인 이외의 타인에게 대여하거나 양도 또는 담보의 목적으로 이용될 수 없습니다. 만일 이를 위반하여 발생하는 모든 책임은 회원에게 귀속됩니다.<br><br>
    
                                            <strong>제 5조 쿠폰 및 포인트 이용</strong><br><br>
    
                                            (1) 쿠폰<br>
                                            가. 쿠폰의 지급 대상, 기준, 사용방식 및 기한 등 구체적인 사항에 대해서는 건별 쿠폰 발생시 별도로 정합니다.<br>
    
                                            나. 회사가 회원에게 지급한 쿠폰은 매장 또는 사이트 내 [마이페이지] 화면에서 조회가 가능합니다.<br>
    
                                            다. 쿠폰은 마케팅 수신 동의한 회원에 한하여 휴대전화 문자 또는 모바일 SNS 채널(카카오톡)등을 통해 발행 정보가 안내되며, <br>발행된 쿠폰은 유효기간 내에 해당 회사의 매장 또는 사이트에서 사용 가능합니다.<br>
    
                                            라. 쿠폰 사용은 건 별 해당 명시 기간까지 사용 가능하며 유효기간이 지난 쿠폰은 사용할 수 없습니다. <br>
                                            매장에서 쿠폰 사용은 회원번호 확인 후 적용되며, 회원번호를 모를 경우 회원 가입 당시 기재한 회원 휴대전화 번호로 회원여부 확인 후 사용할 수 있습니다.<br>
                                            사이트 상에서 사용하는 경우에는 회원 로그인이 요구됩니다.<br>
    
                                            마. 회원이 보유한 다수의 쿠폰의 경우 중복 사용 불가하며, 쿠폰 사용 시 쿠폰 금액 보다 적은 금액의 제품 구입 시에는 잔액을 환불해 드리지 않습니다.<br><br>
    
                                            (2) 포인트<br>
                                            가. 회원이 적립 받은 포인트의 건별 유효기간은 상이할 수 있습니다.<br>
    
                                            나. 1포인트는 1원으로 산정되어 보유포인트가 10포인트 이상일 경우 사용 가능하며, 회사의 매장 또는 사이트 내 마이페이지 화면에서 포인트 내역 조회가 가능합니다.<br>
    
                                            다. 포인트 사용은 건별 유효기간까지 사용 가능하며 유효기간이 지난 포인트는 사용할 수 없습니다. <br>
                                            매장에서 포인트 사용은 회원번호 확인 후 적용되며, 회원번호를 모를 경우 회원 가입 당시 기재한 휴대전화 번호를 토대로 회원여부확인 후 사용할 수 있습니다.<br>
                                            회사 사이트 상에서 사용하는 경우에는 회원 로그인이 요구됩니다.<br><br>
    
                                            (3) 쿠폰 및 포인트 사용의 제한∙소멸 등 <br>
                                            가.   포인트 및 쿠폰 의 유효기간 이후에는 자동 소멸되어 이용하실 수 없습니다.<br>
                                            ...
                                            - 높은 할인율을 적용하여 판매 하는 매장(면세점)에서의 구매 시<br>
                                            ...
                                            바. 쿠폰 및 포인트의 사용에 대한 구체적인 내용은 회사의 사이트에서 고지합니다.<br><br>
    
                                            <strong>제 6조 부정 구매 및 대응 </strong><br><br>
    
                                            (1) 회원이 회사의 매장 및 사이트에서 회사의 상품 등 재화 또는 용역을 구매하는 경우, 그러한 구매가 부정한 목적 또는 방법 (포인트, 쿠폰의 오남용 및 이에 국한하지 않음)에 기한 것으로 부정 구매로 판단될 시 회사는 회원의 당해 구매실적을 취소할 수 있습니다.<br>
                                            (2) 또한 회사는 이 약관 시행 이전에 적립한 포인트가 회사의 규정에 따라 합당한 방법으로 적립된 것이 아니라는 합리적 의심이 드는 경우, 회원의 해당 쿠폰∙포인트의 이용 등을 제한할 수 있으며, 기 발행된 쿠폰∙포인트는 원칙적으로 즉시 소멸되거나 무효처리 됩니다. <br>
    
                                            (3) 회사는 쿠폰 및 포인트 소멸 조치와 별도로 해당 회원에게 민∙형사상의 법적 책임을 물을 수 있고, 제3자가 회사에게 소송을 제기하거나 관계기관을 통한 신고, 기타 분쟁을 야기하는 경우 회원은 회사를 면책하고 모든 책임을 부담해야 합니다.<br>
    
                                            (4) 본 조 제(1)항에 부정구매의 판단은 회사가 1차적으로 담당하며, 회원이 부정구매의 판단에 대해 이의를 제기할 경우, 회사는 회원이 자신의 고의 또는 과실로 인한 부정구매가 발생하지 않았다는 등의 소명을 듣는 예외적인 절차를 마련하여 정상이용 건으로 변경하는 조치를 취할 수 있으나, 회사의 부정사용의 판단에 대하여 회원과 이견이 있는 경우 아래 제29조에 의거, 분쟁을 해결하는 것을 원칙으로 합니다.<br>
    
                                            (5) 본 조 제(1)항에 따른 포인트 및 쿠폰 소멸 조치에 대하여 회사가 본 약관 제 8조 제 2항에 준하는 ‘고지방법’으로 회원에게 부정구매에 따른 구매실적 취소와 포인트 누적 제한에 관하여 통지한 후, 그 통지가 회원에게 도달된 날로부터 30일 이내에 회원으로부터 회사에 별다른 이의제기가 없을 경우에는 회사는 회원이 해당 조치에 동의한 것으로 간주 합니다.<br><br>
    
                                            <strong>제 7조 회원 탈퇴 및 휴면 처리</strong><br><br>
    
                                            (1) 회원이 탈퇴하고자 할 경우에는 언제든지 FILA고객센터(1577-3472) 및 회사 사이트 내 서비스 화면에서 본인 확인을 거쳐 탈퇴를 요청할 수 있습니다. <br>
                                             
                                            (2) 회사는 다음 각 호에 해당하는 사유가 발생하는 경우 해당 회원에게 통지함으로써 회원 자격을 제한•정지 및 상실시켜 휴면 처리 및 탈퇴를 진행할 수 있습니다.<br>
                                            ...
                                            마. 관련법에 따라 1년간 서비스 이용실적이 없는 경우 - 휴면 <br>
    
                                            (3) 이 약관 제 7조 제(2)항 마.호 내지 바.호의 사유에 의해 회사가 회원을 휴면 처리할 경우, 관련 법령에 따라 휴면 예정일로부터 30일 전에 회원에게 고지 후 개인 정보를 분리 보관합니다. 휴면 회원이 될 경우 발행되었던 쿠폰 중 유효기간이 경과한 쿠폰은 효력을 상실하고 유효기간이 경과되지 않은 보유포인트는 유효하며, 휴면 회원이 해지될 경우 유효기간이 경과된 포인트는 자동 소멸됩니다.<br>
    
                                            (4) 탈퇴한 회원의 재가입의 경우, 회사가 정하는 회원 재가입 절차에 따라 재가입이 가능합니다.<br><br>
    
                                            <strong>제 8조 이용약관 효력 및 개정</strong><br><br>
    
                                            (1) 이 약관의 내용은 회원이 이 약관에서 정하는 소정의 가입 절차를 거쳐 성공적으로 회원 가입을 완료 함으로써 효력을 발휘합니다. 또한 회사는 이 약관의 내용을 회원이 쉽게 알 수 있도록 회사의 사이트에 게시합니다.<br>
                                            ...
                                            다만, 약관의 변경 내용이 회원에게 불리하게 변경되는 등 중대한 변경일 경우에는 a) 문자 통보 또는 b) 전자우편(E-mail) 통보 등의 방법으로 개별적으로 알려 드리겠습니다.<br>
                                            - 고지 방법: a)문자 통보, b) 전자우편(E-mail) 통보, c) 회사 사이트(온라인) 게시, d) 매장(오프라인) 게시<br>
    
                                            (3) 약관 변경 사실이 고지된 이후에도 30일 이내에 이의를 제기하지 않고, 회원이 계속적으로 서비스를 이용하는 경우에는 약관의 변경사항에 동의한 것으로 간주합니다.<br>
    
                                            (4) 회원이 약관 변경(개정) 사실에 동의하지 않는 경우엔 회사는 개정 약관의 내용을 적용할 수 없으며, 이 경우 회원은 이용계약을 해지할 수 있습니다. 다만, 기존 약관을 적용할 수 없는 특별한 사정이 있는 경우에는 회사는 이용계약을 해지할 수 있습니다.<br><br>
    
                                            <strong>제 9조 계약의 성립</strong><br><br>
    
                                            (1) 계약은 회원이 되고자 하는 자(이하 "가입신청자")가 약관의 내용에 대하여 동의를 한 다음 회원가입을 신청하고, 회사가 이러한 신청에 대하여 승낙함으로써 체결됩니다.<br>
                                            ...
                                            - 회원의 귀책사유로 인하여 가입 승낙이 불가능하거나 규정한 제반 사항 및 관련 법령을 위반하여 신청하는 경우<br>
    
                                            (3) 제(1)항에 따른 회원가입에 있어 회사는 전문기관을 통한 실명확인 및 본인인증을 요청할 수 있습니다.<br>
    
                                            (4) 회사는 서비스를 제공할 물리적 여유가 없거나, 기술상 또는 업무상 문제가 있는 경우에는 승낙을 유보할 수 있습니다.<br>
    
                                            (5) 제(2)항과 제(4)항에 따라 회원가입의 승낙을 하지 아니하거나 유보한 경우, 회사는 원칙적으로 이를 가입신청자에게 알리도록 합니다.<br>
    
                                            (6) 이용계약의 성립 시기는 회사가 가입완료를 신청절차 상에서 표시한 시점으로 합니다.<br><br>
    
                                            <strong>제 10조 지급방법 </strong><br><br>
    
                                            회원이 회사의 매장 또는 사이트에서 구매한 상품에 대한 대금지급방법은 다음 각 호의 방법 중 가용한 방법으로 할 수 있습니다. 이 경우, 회사는 회원의 지급방법에 대하여 상품 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.<br>
                                            ...
                                            바. 기타 전자적 지급 방법에 의한 대금 지급 등<br><br>
    
                                            <strong>제11조 사이트 내 구매 시 수신확인 통지, 구매신청 변경 및 취소</strong><br><br>
                                             
                                            (1) 회사는 회원의 사이트 내 구매신청이 있는 경우 회원에게 수신확인통지를 합니다.<br>
                                             
                                            (2) 전항에 따라 수신확인통지를 받은 회원이 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고, 회사는 배송 전에 회원의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제14조의 청약철회 등에 관한 규정에 따릅니다.<br><br>
                                             
                                            <strong>제 12조 사이트 내 구매 시 상품 등의 공급</strong><br><br>
    
                                            (1) 회사는 회원과 상품 등의 공급시기에 관하여 별도의 약정이 없는 이상, 회원이 사이트 내에서 상품을 구매한 날부터  [7] 영업일 이내에 상품 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, 회원과 상품 등의 공급시기에 관하여 별도의 약정(상품 등의 공급시기에 관한 상세페이지를 통한 안내 포함)이 있었다면 그 약정에 따릅니다. 이때 회사는 회원이 상품 등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한 조치를 합니다.<br>
    
                                            (2) 회사는 회원이 구매한 상품에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 회사가 약정 배송기간을 초과한 경우에는 그로 인한 회원의 손해를 배상하여야 합니다. 다만 회사가 고의․과실이 없음을 입증한 경우에는 그러하지 아니합니다.<br><br>
    
                                            <strong>제13조 환급</strong><br><br>
    
                                            회사는 회원이 구매 신청한 상품 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 회원에게 통지하고 사전에 상품 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.<br><br>
    
                                            <strong>제 14조 청약철회 등</strong><br><br>
    
                                            (1) 회사에서 상품 등의 구매에 관한 계약을 체결한 회원은 사이트의 경우 7일 이내에 청약 철회를 할 수 있습니다. 다만, 청약철회에 관하여 관련법령에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다. <br>
                                            회원이 상품 등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br>
                                            ...
                                            (2) 전 항의 나.호 내지 라.호의 경우, 회사가 사전에 청약철회 등이 제한되는 사실을 회원이 쉽게 알 수 있는 곳에 명시하거나 상품을 제공하는 등의 조치를 하지 않았다면 회원의 청약철회 등이 제한되지 않습니다<br>
    
                                            (3) 회원은 본 조 제1항 및 제2항의 규정에도 불구하고 상품 등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 상품 등을 공급받은 날부터 3월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.<br><br>
    
                                            <strong>제15조 청약철회 등의 효과</strong><br><br>
    
                                            (1) 회사는 회원으로부터 상품 등을 반환 받은 경우 3영업일 이내에 이미 지급받은 상품 등의 대금을 환급합니다. 이 경우 회사가 회원에게 상품 등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하고 있는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.<br>
    
                                            (2) 회사는 대금을 환급함에 있어서 회원이 신용카드 또는 기타 전자적 지급방법 등의 결제수단으로 상품 등의 대금을 지급한 때에는 지체 없이 당해 결제수단을 제공한 사업자로 하여금 상품 등의 대금의 청구를 정지 또는 취소하도록 요청합니다.<br>
    
                                            (3) 청약철회 등의 경우 공급받은 상품 등의 반환에 필요한 비용은 회원이 부담합니다. 회사는 회원에게 청약철회 등을 이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 상품 등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행되어 회원이 청약철회 등을 하는 경우 상품 등의 반환에 필요한 비용은 회사가 부담합니다.<br>
    
                                            (4) 회원이 상품 등을 제공받을 때 발송비를 부담한 경우에 회사는 청약철회 시 그 비용을 누가 부담하는지를 회원이 알기 쉽도록 명확하게 표시합니다.<br><br>
    
                                            <strong>제 16조 사이트 서비스의 제공 및 이용</strong><br><br>
    
                                            (1) 회사는 업무상, 기술상의 특별한 장애요인이 없는 한 사이트 서비스를 연중무휴, 1일 24시간 제공함을 원칙으로 합니다.<br>
    
                                            (2) 회사는 정기점검 등의 필요로 인하여 회사가 정한 기간 또는 다음 각 호의 사유가 있을 경우 서비스 제공을 일시적으로 중단할 수 있으며, 이 경우 제 24조 [회원에 대한 통지]에 따른 방법으로 미리 안내합니다. 다만, 회사가 사전에 안내할 수 없는 부득이한 사유가 있는 경우 사후에 안내할 수 있습니다.<br>
                                            - 서비스 설비의 증설, 교체, 보수점검 등 공사로 인한 경우<br>
                                            - 전기통신사업법에 규정된 기간통신사업자가 전기 통신 서비스를 중지했을 경우<br>
                                            - 정전, 통신두절, 전자장치의 장애 발생 등 예상치 못한 사유가 발생한 경우<br>
                                            - 천재지변 등 불가항력적 사유 등 기타 운영상 상당한 이유가 있는 경우<br>
    
                                            (3) 제(2)항의 경우 회사는 서비스 중단에 대하여 면책되며, 회원은 회원가입 이후라 할지라도 일부 서비스 이용 시 회사 사정에 따라 서비스 이용이 제한 될 수 있습니다.<br><br>
    
                                            <strong>제 17조 회원정보의 변경</strong><br><br>
    
                                            (1) 회원은 회사 사이트 내 개인정보 관리화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 실명, 아이디 등은 수정이 불가능합니다.<br>
    
                                            (2) 회원은 회원가입 신청시 기재한 사항이 변경 되었을 경우, 사이트에 로그인 후 수정 하거나 FILA 고객센터(1577-3472)로 연락하여 본인 확인 후 변경사항을 알려서 수정해야 합니다.<br>
    
                                            (3) 제(2)항의 변경사항을 회사에 알리지 않아 발생한 불이익에 대하여 회사는 책임지지 않습니다.<br><br>
    
                                            <strong>제 18조 서비스의 변경</strong><br><br>
    
                                            (1) 회사는 상당한 이유가 있는 경우에 운영상, 기술상의 필요에 따라 제공하고 있는 사이트의 전부 또는 일부 서비스를 변경할 수 있습니다.<br>
    
                                            (2) 회사는 회원에 대한 서비스의 변경이 있는 경우에는 회사는 변경사유, 변경될 서비스의 내용 및 제공일자 등은 그 변경 전에 해당 서비스 초기화면에 게시하며, 이 약관 제8조의 약관 변경의 절차를 진행합니다. <br>
    
                                            (3) 회사는 무료로 제공되는 서비스의 일부 또는 전부를 이 약관 제8조의 약관 변경 절차를 거쳐 회사의 정책 및 운영의 필요상 수정, 중단, 변경할 수 있으며, 이에 대하여 관련법에 특별한 규정이 없는 한 회원에게 별도의 보상을 하지 않습니다.<br><br>
    
                                            <strong>제 19조 정보의 제공 및 광고의 게재</strong><br><br>
    
                                            (1) 회사는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보를 공지사항이나 문자 및 전자우편 (e-mail) 등의 방법으로 회원에게 제공할 수 있습니다. 다만, 회원은 관련법에 따른 거래관련 정보 및 고객문의 등에 대한 답변 등을 제외하고는 언제든지 문자 및 전자우편 (e-mail) 에 대해서 수신 거절을 할 수 있습니다.<br>
    
                                            (2) 제(1)항의 정보를 회원에게 전송하려고 하는 경우에는 사전 동의를 받아서 전송합니다. 다만, 회원의 거래관련 정보 및 고객문의 등에 대한 회신에 있어서는 제외됩니다.<br>
    
                                            (3) 회원은 회사가 제공하는 서비스와 관련하여 게시물 또는 기타 정보를 변경, 수정, 제한하는 등의 조치를 취하지 않습니다.<br><br>
    
                                            <strong>제 20조 회사의 의무</strong><br><br>
    
                                            (1) 회사는 관련법과 이 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 이 약관에서 정한 바에 따라 계속적이고 안정적으로 서비스를 제공하기 위하여 최선을 다하여 노력합니다.<br>
    
                                            (2) 회사는 회원이 안전하게 서비스를 이용할 수 있도록 개인정보(신용정보 포함)보호를 위해 보안시스템을 갖추어야 하며 개인정보처리방침을 공시하고 준수합니다.<br>
    
                                            (3) 회사는 서비스이용과 관련하여 발생하는 회원의 불만 또는 피해구제요청을 적절하게 처리할 수 있도록 필요한 인력 및 시스템을 구비합니다.<br>
    
                                            (4) 회사는 서비스이용과 관련하여 회원으로부터 제기된 의견이나 불만이 정당하다고 인정할 경우에는 이를 처리하여야 합니다. 회원이 제기한 의견이나 불만사항에 대해서는 게시판을 활용하거나 문자 및 전자우편 (e-mail) 등을 통하여 회원에게 처리과정 및 결과를 전달합니다.<br><br>
    
                                            <strong>제 21조 개인정보보호 의무 및 이용</strong><br><br>
    
                                            (1) 회사는 관련 법령에서 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 개인정보보호법 및 기타 관련 법령 및 회사의 개인정보처리방침이 적용됩니다. 다만, 회사의 공식 사이트 이외, 회사가 운영하지 않는 사이트에서는 회사의 개인정보처리방침이 적용되지 않습니다.<br>
    
                                            (2) 회사는 회원의 개인신상 정보를 본인의 승낙 없이 타인에게 누설, 배포하지 않습니다. 다만, 관련법령에 의하여 관계기관 등의 요구가 있는 경우에는 그러하지 아니합니다.<br>
    
                                            (3) 회사는 회원에게 맞춤서비스, 커뮤니티서비스, 모바일서비스, 쇼핑몰서비스 등 다양한 서비스를 제공할 목적으로 여러 분야의 컨텐츠 사업자 혹은 비즈니스 사업자와 함께 파트너십을 맺어 회원의 개인정보를 이용할 수 있습니다. 이러한 경우에도 개인정보의 제3자 제공은 회원의 사전동의 하에서만 이루어집니다.<br><br>
    
                                            <strong>제 22조 회원의 의무</strong><br><br>
    
                                            (1) 회원은 회사 사이트의 정상적인 운영을 저해하는 다음 각 호의 행위를 하여서는 아니 되며, 관련법령, 이 약관의 규정, 이용안내 및 서비스와 관련하여 공지한 주의사항 등을 준수하여야 하고, 기타 회사의 정상적인 업무에 방해되는 행위를 하여서는 안 됩니다.<br>
                                            ...
                                            타. 기타 불법적이거나 부당한 행위 ,<br>
    
                                            (2) 전항 각 호의 행위 발생 시, 회사 또는 제3자에게 유, 무형의 피해발생이 예상되는 경우, 회사는 회원이 작성한 게시물의 공개를 임시적으로 중단할 수 있으며, 최종 확인과정을 거쳐 해당 게시물을 삭제할 수 있습니다.<br><br>
    
                                            <strong>제 23조 회원의 아이디 및 비밀번호 등 관리의무</strong><br><br>
    
                                            (1) 회원의 "아이디"와 "비밀번호"에 관한 관리책임은 회원에게 있으며, 이를 제3자가 이용하도록 하여서는 안 됩니다.<br>
    
                                            (2) 회사는 회원의 "아이디"가 개인정보 유출 우려가 있거나, 반사회적 또는 미풍양속에 어긋나거나 회사 및 회사의 운영자로 오인될 우려가 있는 경우, 해당 "아이디"의 이용을 제한할 수 있습니다.<br>
    
                                            (3) 회원은 "아이디" 및 "비밀번호"가 도용되거나 제3자가 사용하고 있음을 인지한 경우에는 이를 즉시 회사에 통지하고 회사의 안내에 따라야 합니다.<br>
    
                                            (4) 제3항의 경우에 해당 회원이 회사에 그 사실을 통지하지 않거나, 통지한 경우에도 회사의 안내에 따르지 않아 발생한 불이익에 대하여 회사는 책임지지 않습니다.<br>
    
                                            (5) 회원의 ID가 부정하게 사용된 경우 회원은 반드시 회사에 그 사실을 통보하여야 하며, 회원의 관리부실로 타인이 ID를 사용하게 되어 일어날 수 있는 제반 손해에 대한 책임은 회원 본인에게 귀속됩니다.<br>
    
                                            (6) 회원의 개인정보를 변경하여야 하는 경우에는 반드시 회원 본인이 직접 수정하여 등록하여야 합니다.<br>
    
                                            (7) 회원은 이 약관 및 관련법령에서 규정한 사항을 준수하여야 합니다.<br><br>
    
                                            <strong>제 24조 회원에 대한 통지</strong><br><br>
    
                                            (1) 회사가 회원에 대한 통지를 하는 경우 이 약관에 별도 규정이 없는 한 서비스 내 문자 및 전자우편 (e-mail) 등으로 할 수 있습니다.<br>
    
                                            (2) 회사는 회원 전체(일부라도 불특정 다수인 경우 포함)에 대한 통지의 경우 7일 이상 회사의 홈페이지에 게시함으로써 제1항의 통지에 갈음할 수 있습니다.<br><br>
    
                                            <strong>제 25조 회사의 계약해지 및 서비스 이용제한</strong><br><br>
    
                                            (1) 회사는 회원이 제9조 제(2)항의 각 호의 어느 하나에 해당되는 행위를 하거나, 관련법령 또는 이 약관을 위반할 경우, 이용계약을 해지하거나 또는 기간을 정하여 서비스 이용을 제한 또는 중지할 수 있습니다.<br>
    
                                            (2) 본 조에 따라 서비스 이용을 제한하거나 계약을 해지하는 경우에는 회사는 제24조 [회원에 대한 통지]에 따라 통지합니다. 단, 즉시 조치를 취하지 않을 경우, 회사 또는 제3자에게 유, 무형의 손해 발생이 예상되는 경우는 조치를 취한 후, 통지할 수 있습니다.<br>
    
                                            (3) 회원은 본 조에 따른 이용제한 등에 대해 회사가 정한 절차에 따라 이의신청을 할 수 있습니다. 이 때 이의가 정당하다고 회사가 인정하는 경우 회사는 즉시 서비스의 이용을 재개합니다.<br><br>
    
                                            <strong>제 26조 저작권 등 권리의 귀속</strong><br><br>
    
                                            (1) 회사가 작성한 서비스와 관련된 저작물에 대한 저작권 및 일체의 지식재산권은 회사에 귀속됩니다. 단, 회원의 "게시물"은 해당 게시물의 저작자에게 귀속됩니다.<br>
    
                                            (2) 회원은 서비스를 이용함으로써 얻은 정보를 회사의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 아니됩니다. <br>
    
                                            (3) 회사는 서비스와 관련하여 회원에게 회사가 정한 이용조건에 따라 계정, "아이디" 콘텐츠 등을 이용할 수 있는 이용권만을 부여하며, 회원은 이를 양도, 판매, 담보제공 등의 처분행위를 할 수 없습니다.<br><br>
    
                                            <strong>제 27조 게시물의 관리</strong><br><br>
    
                                            (1) 회원의 "게시물"이 관련법에 위반되는 내용을 포함하는 경우, 권리자는 관련법이 정한 절차에 따라 해당 "게시물"의 게시중단 및 삭제 등을 요청할 수 있으며, 회사는 관련법에 따라 조치를 취하여야 합니다.<br>
    
                                            (2) 회사는 전항에 따른 권리자의 요청이 없는 경우라도 회사 또는 제3자의 권리침해가 인정될 만한 사유가 있거나 기타 회사 정책 및 관련법에 위반되는 경우에는 관련법에 따라 해당 "게시물"에 대해 임시조치 등을 취할 수 있습니다.<br><br>
    
                                            <strong>제 28조 문자, 전자우편(e-mail), 우편(DM) 발송 및 유선 연락</strong><br><br>
    
                                            회사는 회원의 포인트 및 쿠폰에 대한 정보와 회사의 서비스 등을 제공하기 위해 필요한 경우 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 등 관련 법령에 따라 문자, 전자우편(e-mail), 우편(DM), 유선 전화(TM)를 통해 서비스 정보를 제공할 수 있습니다. <br>
                                            단, event, 신상품소개 등 영리목적의 광고성 정보를 제공하기 위하여서는 회원의 동의를 요하며, 회원이 동의를 철회하는 경우에는 이를 즉시 중단합니다. <br>
                                            회사는 제1항 및 제2항의 문자, 전자우편(e-mail), 우편(DM) 발송 및 유선 연락 시 거부의사를 표시할 수 있는 방법을 안내해드립니다.<br><br>
    
                                            <strong>제 29조 약관 위배시의 책임/손해 배상 및 분쟁 조정</strong><br><br>
    
                                            (1) 회사와 회원은 이 약관을 위반함으로써 발생하는 모든 책임을 각자가 부담하고, 이로 인하여 상대방에게 손해를 입힌 경우에는 배상하여야 합니다.<br>
    
                                            (2) 회사는 회사가 개인정보처리자로서 의무를 다한 경우, 회원이 서비스를 이용하는데 있어서 회사에게 고의 또는 중과실이 있지 않는 한 회원에게 발생한 손해를 배상하지 않습니다.<br>
    
                                            (3) 이 약관에서 정하지 않은 사항과 이 약관의 해석 및 분쟁 조정에 관해서는 관련법령 또는 상 관례에 따릅니다.<br><br>
    
                                            <strong>제 30조 책임제한</strong><br><br>
    
                                            (1) 회사는 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.<br>
    
                                            (2) 회사는 이 약관 위반 등 회원의 귀책사유로 인한 서비스 이용의 장애에 대하여는 책임을 지지 않습니다.<br>
    
                                            (3) 회사는 회원이 서비스와 관련하여 게재한 정보, 자료, 사실의 신뢰도, 정확성 등의 내용에 관하여는 책임을 지지 않습니다.<br>
    
                                            (4) 회사는 회사와 관련 없이 회원 간 또는 회원과 제3자 상호간에 회사가 제공한 서비스와 관련된 거래를 한 경우, 회원 또는 제3자에게 손해가 발생시 회사의 귀책사유가 있는 경우를 제외하고는 회원 또는 제3자에 대하여 책임을 지지 않습니다.<br> 
    
                                            (5) 회사는 무료로 제공되는 서비스 이용과 관련하여 회원에게 손해가 발생하는 경우, 회사의 귀책사유 또는 관련법령에 규정이 없는 한 책임을 지지 않습니다.<br><br>
    
                                            <strong>제 31조 준거법 및 재판관할</strong><br><br>
    
                                            (1) 회사와 회원 간 제기된 소송은 대한민국법을 준거법으로 합니다.<br>
    
                                            (2) 회사와 회원간 발생한 분쟁에 관한 소송은 제소 당시의 회원의 주소에 의하고, 주소가 없는 경우 거소를 관할하는 지방법원의 전속관할로 합니다. 단, 제소 당시 회원의 주소 또는 거소가 명확하지 아니한 경우의 관할법원은 민사소송법에 따라 정합니다.<br><br>
                            ...
                            <li class="mt18 mt18_02">
                                <p>
                                    <input type="checkbox" class=" chk__style  _basic_type" name="agree2" id="agree2" onclick="agrees2022();">
                                    <label for="agree2" class="join_label ">개인 정보의 수집 및 이용에 관한 동의 <span class="red">(필수)</span></label>
                                </p>
                                <button type="button" class="btn_view"><img src="/pc/resource/images/common/arr_right_bk_6x10.png" alt=""></button>
                                <div class="cs-agree-con">
                                    <div class="head">
                                    ...
                                    <div class="box _scroll">
                                        <p>
                                            ...
                                            회사는 회원가입을 위하여 필요한 최소한의 개인정보를 수집합니다.<br>  
                                            개인정보 수집에 동의하지 않을 수 있으나 이 경우 회원가입이 제한될 수 있습니다.
                            ...
                            <li class="mt12 mt18_01">
                                <p>
                                    <input type="checkbox" class=" chk__style  _basic_type" name="agree3" id="agree3" onclick="agrees2022();">
                                    <label for="agree3" class="join_label ">개인 정보의 수집 및 이용에 관한 동의 <span class="">(선택)</span></label>
                                </p>
                                <button type="button" class="btn_view"><img src="/pc/resource/images/common/arr_right_bk_6x10.png" alt=""></button>
                            ...
                            <li class="mt12 mt18_02">
                                <p>
                                    <input type="checkbox" class=" chk__style  _basic_type" name="agree4" id="agree4" onclick="agrees2022();">
                                    <label for="agree4" class="join_label ">개인정보 국외 이전에 관한 동의<span class="red"> (필수)</span></label>
                                </p>
                                <button type="button" class="btn_view"><img src="/pc/resource/images/common/arr_right_bk_6x10.png" alt=""></button>
                            ...
                            <li class="">							
                                <p class="star" style="margin-bottom: 10px;">정보 제공 동의하신 고객에 한하여 다양한 혜택 제공이 가능합니다.</p>
                            </li>
                        </ul>
                        <ul class="agree_mkt">
                            <li class="all w100">
                                <span class="mkt_tit">마케팅 정보 수신 동의
                                </span>
                            ...
                            <li class="mt18 mt18_02 --open">
                                <span class="">
                                    ...
                                    <label for="MemberIsMaillinglist" class="join_label ">E-MAIL 수신 동의 (선택)</label>
                                </span>		
                            ...
                            <!-- <li>							
                                ...
                                <span>
                                    ...
                                    <label for="MemberIsTM" class="join_label ">TM 수신 동의 (선택)</label>
                                </span>
                                
                            </li> -->
                            <li class="w100 --open" style="padding: 0 2px 0 28px;">							
                                <p class="star">E-Mail, SMS(알림톡)을 통한 상품 및 이벤트 정보 수신에 동의합니다. </p>
                                <p class="star" style="margin-bottom: 10px;">회원가입 및 거래정보(주문, 반품, 교환)등의 메일은 마케팅 정보 수신과 무관하며, 개인정보보호법 제15조제1항에 의거 '정보주체와의 계약의 체결 및 이행을 위하여 불가피하게 필요한 경우'에 해당하므로 수신동의를 하지 않더라도 모든 회원에게 발송됩니다.</p>
                            </li>
                        </ul>
                        <ul >
                            <li class="all w100" style="border: 1px solid rgb(213,220,228); position: relative; width: 96%;">
                                <p>
                                    개인정보 필수 위탁에 대한 안내
                                </p>
                                <button type="button" class="btn_view" style="position: absolute; right: 23px;"><img src="/pc/resource/images/common/arr_right_bl_7x11.png" alt=""></button>
                                <div class="cs-agree-con">
                                    <div class="head">
                            ...
                            <li class="pl0 all all_before" style="margin-top: 10px;">							
                                <p class="star red">필수항목에 동의하지 않으실 경우 회원가입이 불가합니다.</p>
                                <p class="star red">선택항목은 동의하지 않으셔도 서비스 이용이 가능합니다.</p>
                            </li>			
                        </ul>
                    </div>						
                    <!-- //2021-03-02 개인정보 수정-->
                    ...
                    <!--통합회원가입 관련문구-->
                    <div class="join_membership chk-box">
                            <img src="/pc/resource/images/sub/join_membership_logo_d.png" alt="">
                            <div class="txt-box">
                                <p class="tit">[통합멤버십 동의] <span class="red">(필수)</span></p>
                                <p class="desc">
                                    케즈 온라인스토어에서는 한번의 가입으로 FILA KOREA 에서 운영하는 전 브랜드의 고객 혜택 사용이 가능한<br/>
                                    통합 멤버십 서비스로 운영 중 입니다. 이에 동의하시면 통합 멤버십에 가입됩니다. 
                                </p>
                            </div>
                            <div class="gender" id="bday3">		
                                <span>
                            ...
                            <!-- <div class="rd-box">
                                <input type="radio" class=" chk__style  _basic_type" id="totalMembership01" name="totalMembership" value="1" >
                                <label for="totalMembership01" class="join_label ">동의</label>
                            
                                <input type="radio" class=" chk__style  _basic_type" id="totalMembership02" name="totalMembership" value="0" >
                    ...
                    <div class="btn-box join__btn" id="loginButton">
                        <a href="javascript:sendform_simple2022();void(0);" class="btn btn_style">동의하고 가입하기</a>
                    </div>
